...
class Transaction extends \AppBundle\Entity\Transaction implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'amount', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'customId', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'customer'];
        }
